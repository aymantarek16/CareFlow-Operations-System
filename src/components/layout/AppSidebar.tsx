...
export function AppSidebar({ user }: { user: AppUser }) {
  ...
  return (
    <aside className="panel sticky top-5 hidden h-[calc(100vh-2.5rem)] overflow-hidden rounded-[34px] lg:block">
      <div className="h-full overflow-y-auto p-5 pe-3 [scrollbar-gutter:stable]">
        {/* Brand */}
